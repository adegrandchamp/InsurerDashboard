...
#Training the model
rsf = RandomSurvivalForest(random_state=42, n_jobs=-1) #,verbose =2
grid_search = GridSearchCV(rsf, param_grid, cv=5,
...
rsf = RandomSurvivalForest(**best_params,random_state=42,n_jobs=-1) #,verbose=2)
